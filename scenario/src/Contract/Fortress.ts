...
export interface FTSScenarioMethods extends FTSMethods {
...
export interface FTS extends Contract {
  methods: FTSMethods;
  name: string;
}

export interface FTSScenario extends Contract {
  methods: FTSScenarioMethods;
  name: string;
}
