...
This checks to see if the deployed byte-code matches this version of the Fortress Protocol.
...
npx saddle -n rinkeby script token:match 0x19B674715cD20626415C738400FDd0d32D6809B6 '{
  ...
  "name": "Fortress Kyber Network Crystal",
  "symbol": "vKNC",
  "decimals": "8",
  "admin": "$Timelock"
}'
...
(async function() {
  ...
  console.log(`Matching fToken at ${address} with ${JSON.stringify(conf)}`);
  ...
  await saddle.match(address, 'FBep20Immutable', deployArgs);
